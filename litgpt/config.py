        ...
        if name not in name_to_config:
            ...
            try:
                conf_dict = next(
                    ...
                    or (
                        config["hf_config"]["org"] is not None
                        and config["hf_config"]["org"] + "/" + config["hf_config"]["name"] == name
                    )
                )
...
olmo2 = [
    ...
    # 136M olmo2. Transformer core is ~44M params
    dict(
        name="OLMo-2-136M{}",
        hf_config=dict(org=None, name="custom-olmo2-136m{}"),
        vocab_size=100278,
        padded_vocab_size=100352,
        block_size=4096,
        n_embd=512,
    ...
    # 233M olmo2. Transformer core is ~106M params
    dict(
        name="OLMo-2-233M{}",
        hf_config=dict(org=None, name="custom-olmo2-233m{}"),
        vocab_size=100278,
        padded_vocab_size=100352,
        block_size=4096,
        n_embd=640,
    ...
    # 728M olmo2. Transformer core is ~425M params
    dict(
        name="OLMo-2-728M{}",
        hf_config=dict(org=None, name="custom-olmo2-728m{}"),
        vocab_size=100278,
        padded_vocab_size=100352,
        block_size=4096,
        n_embd=1280,
    ...
    # 1B olmo2. Transformer core is ~644M params
    dict(
        name="OLMo-2-1B{}",
        hf_config=dict(org=None, name="custom-olmo2-1B{}"),
        vocab_size=100278,
        padded_vocab_size=100352,
        block_size=4096,
        n_embd=1408,
    ...
    dict(
        name="OLMo-2-3B{}",
        hf_config=dict(org=None, name="custom-olmo2-3B{}"),
        vocab_size=100278,
        padded_vocab_size=100352,
        block_size=4096,
        n_embd=2560,
    ...
    # 1B olmo2 (actual total params is ~1.5B)
    dict(
        name="OLMo-2-0425-1B{}",
        hf_config=dict(org="allenai", name="OLMo-2-0425-1B{}"),
        vocab_size=100278,
        padded_vocab_size=100352,
        block_size=4096,
        n_embd=2048,
